<div style="margin-top: 14px; background-color: white;padding: 30px">
	...
	<form action="<?php echo base_url('index.php/admin/member/index') ?>" method="get">
		<div class="row">
			<div class="col"><input type="text" name="string" class="form-control" placeholder="masukan Nama atau noregis" style="width: 100%"></div>
			<div class="col"><input type="text" name="tahun" class="form-control" placeholder="masukan Tahun Penerimaan" style="width: 100%"></div>
			<div class="col">
				<select class="form-control" name="gelombang">
					<option value=" ">-- Pilih Gelombang -- </option>
					<option value=" ">Semua gelombang</option>
					<option value="1">-- Gelombang 01 -- </option>
					<option value="2">-- Gelombang 02 -- </option>
					<option value="3">-- Gelombang 03 -- </option>
				</select>
			</div>
		</div>
			...
			<tr>
				...
				<td>
					<?php if ($data->status_bayar == 1): ?>
						<span class="text-success">Sdh membayar</span>
					<?php else: ?>
						<span class="text-danger">Blm membayar</span>
					<?php endif ?>
				</td>

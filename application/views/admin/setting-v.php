		...
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="tahun_ajaran" id="tahun_ajaran" aria-describedby="tahun_ajaran" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->tahun_ajaran ?>">
					<small id="kode_pt" class="form-text text-muted">Semua jenis karakter (Huruf, Angka dan simbol) Dapat digunakan</small>
				</div>
			</div>
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="kode_ta" id="kode_ta" aria-describedby="kode_ta" placeholder="Kode Tahun Ajaran" value="<?php echo $infopt->kode_ta ?>">
					<small id="kode_ta" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="tahun" id="tahun_ajaran" aria-describedby="tahun" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->tahun ?>">
			...
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="kode_tahun" id="kode_tahun" aria-describedby="kode_tahun" placeholder="Kode Tahun Ajaran" value="<?php echo $infopt->kode_tahun ?>">
					<small id="kode_tahun" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="gelombang" id="gelombang" aria-describedby="gelombang" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->gelombang ?>">

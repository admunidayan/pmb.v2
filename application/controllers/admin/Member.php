	...
	public function index(){
		if ($this->ion_auth->logged_in()) {
			...
			if (!$this->ion_auth->in_group($level)) {
                ...
                $config['total_rows'] = $this->Admin_m->count_data_member(@$post['string'],@$post['tahun'],@$post['gelombang']); //total row
				...
				$data['hasil'] = $this->Admin_m->select_all_data_member($config["per_page"], $data['offset'],@$post['string'],@$post['tahun'],@$post['gelombang']);
